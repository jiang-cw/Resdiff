...
class UNet(nn.Module):
    def __init__(self, input_nc = 1, output_nc = 1, num_downs = 5, ngf=32, norm_layer=nn.BatchNorm3d, use_dropout=False):
...
class Discriminator(nn.Module):
    def __init__(self, image_channels = 2, channels = [16, 32, 64, 128], n_layers=3):
